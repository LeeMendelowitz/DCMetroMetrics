    ...
    return {
      ...
      link: function postLink(scope, element, attrs) {
        ...
        var draw = function() {
          ...
          var bisectDate = d3.bisector(function(d) { return d.day_as_date; }) .left; // Finds value in sorted array
          ...
          function brushed() {
              ...
              dailyDataInView = dailyData.filter(function(d) {
                return d.day_as_date >= domain[0] && d.day_as_date <= domain[1];
              });
              ...
              if( brush.empty() ) {
                ...
                scatterCircles.classed("scatter-hidden", function(d) {
                  ...
                  return d.day_as_date < startDay || d.day_as_date > endDay;
                });
          ...
          function drawVoronoi(dailyDataInView) {
            ...
            paths.on("mouseover" , function(d) {
              ...
              setLinePlotTracker(d.point, x(d.point.day_as_date), y(d.point.count), yTempScale(d.point.temp));
          ...
          var countArea = d3.svg.area()
            ...
            .x(function(d) { return x(d.day_as_date); })
            .y0(height)
            .y1(function(d) { return y(d.count); });

          var countArea2 = d3.svg.area()
            .interpolate("monotone")
            .x(function(d) { return x2(d.day_as_date); })
            .y0(height2)
          ...
          <!-- <table class="table-striped"> -->\
            <tr><th>Date</th><td>{{ d.day_as_date | date : "EEE M/d/yy" }}</td></tr>\
          ...
          hotCarDirectory.get_daily_data().then( function(data) {
            ...
            dailyData.forEach(function(d) {
              ...
              d.dateString = d.day;
              d.day_as_date = parseDate(d.day);
              d.temp = d.temp ? +d.temp : null;
              d.count = +d.count;
              d.year = d.day_as_date.getFullYear();

            });

            dailyDataInView = dailyData;

            x.domain(d3.extent(dailyData, function(d) { return d.day_as_date; }));
            ...
            function mousemoveLinePlot() {    
              ...
              // Set the locations of the countTracker, tempTracker, and lineTracker
              setLinePlotTracker(d, x(d.day_as_date), y(d.count), yTempScale(d.temp));
              focusScatterPt(d);
